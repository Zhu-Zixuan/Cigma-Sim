...
_value_config = InternalPrecisionConfig(
    rounding_mode=RoundingMode.FULL_DOWN,
)
...
_data_configs: dict[tuple[FloatFormat | int, FloatFormat | int], _DataConfig] = {
    (8, 8): _DataConfig(segment_len=64, window_size=64, lane_count=8),
    (16, 16): _DataConfig(segment_len=64, window_size=64, lane_count=16),
    (BFLOAT16, BFLOAT16): _DataConfig(segment_len=64, window_size=64, lane_count=8 + 1),
    (FLOAT16, FLOAT16): _DataConfig(segment_len=64, window_size=64, lane_count=11 + 1),
    (FLOAT32, FLOAT32): _DataConfig(segment_len=64, window_size=64, lane_count=24 + 1),
}
